const DISPLAY_NAME = '§a消§b耗§9卡 §d- §a夜视 I';
...
function skillBuff(player) {
    ...
    //提供夜视效果
    const nightVisionEffect = PotionEffectType.getByName("NIGHT_VISION") || PotionEffectType.NIGHT_VISION;

    const buffs = [
        new PotionEffect(nightVisionEffect, BUFF_TICKS, 0)
    ];
