const DISPLAY_NAME = '§a消§b耗§9卡 §d- §a村庄英雄 I';
...
function skillBuff(player) {
    ...
    //提供村庄英雄效果
    const heroOfTheVillageEffect = PotionEffectType.getByName("HERO_OF_THE_VILLAGE") || PotionEffectType.HERO_OF_THE_VILLAGE;

    const buffs = [
        new PotionEffect(heroOfTheVillageEffect, BUFF_TICKS, 0)
    ];
