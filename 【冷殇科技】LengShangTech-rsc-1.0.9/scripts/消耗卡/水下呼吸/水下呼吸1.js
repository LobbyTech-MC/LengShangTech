const DISPLAY_NAME = '§a消§b耗§9卡 §d- §a水下呼吸 I';
...
function skillBuff(player) {
    ...
    //提供水下呼吸效果
    const waterBreathingEffect = PotionEffectType.getByName("WATER_BREATHING") || PotionEffectType.WATER_BREATHING;

    const buffs = [
        new PotionEffect(waterBreathingEffect, BUFF_TICKS, 0)
    ];
