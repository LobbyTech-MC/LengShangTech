const DISPLAY_NAME = '§a消§b耗§9卡 §d- §a海豚的恩惠 I';
...
function skillBuff(player) {
    ...
    //提供海豚的恩惠效果
    const dolphinsGraceEffect = PotionEffectType.getByName("DOLPHINS_GRACE") || PotionEffectType.DOLPHINS_GRACE;

    const buffs = [
        new PotionEffect(dolphinsGraceEffect, BUFF_TICKS, 0)
    ];
