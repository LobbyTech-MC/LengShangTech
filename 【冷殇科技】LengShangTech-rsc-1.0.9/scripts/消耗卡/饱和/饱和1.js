const DISPLAY_NAME = '§a消§b耗§9卡 §d- §a饱和 I';
...
function skillBuff(player) {
    ...
    //提供饱和效果
    const saturationEffect = PotionEffectType.getByName("SATURATION") || PotionEffectType.SATURATION;

    const buffs = [
        new PotionEffect(saturationEffect, BUFF_TICKS, 0)
    ];
