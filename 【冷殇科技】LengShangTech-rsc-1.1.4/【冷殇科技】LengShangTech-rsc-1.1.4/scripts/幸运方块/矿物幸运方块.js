...
const SlimyGroup = [
    /* 普通单抽组 40% */
    {
        ...
        allDrop: false,
        items: [
            { type: 'vanilla', id: 'IRON_INGOT', amount: {min:1, max:64} },//铁锭
            { type: 'vanilla', id: 'GOLD_INGOT', amount: {min:1, max:64} },//金锭
            { type: 'vanilla', id: 'NETHERITE_INGOT', amount: {min:1, max:64} },//下界合金锭
            { type: 'vanilla', id: 'NETHERITE_SCRAP', amount: {min:1, max:64} },//下界合金碎片
            { type: 'vanilla', id: 'IRON_NUGGET', amount: {min:1, max:64} },//铁粒
            { type: 'vanilla', id: 'GOLD_NUGGET', amount: {min:1, max:64} },//金粒
            { type: 'vanilla', id: 'IRON_BLOCK', amount: {min:1, max:64} },//铁块
            { type: 'vanilla', id: 'GOLD_BLOCK', amount: {min:1, max:64} },//金块
            { type: 'vanilla', id: 'NETHERITE_BLOCK', amount: {min:1, max:8} },//下界合金块
            { type: 'vanilla', id: 'DIAMOND', amount: {min:1, max:64} },//钻石
            { type: 'vanilla', id: 'DIAMOND_BLOCK', amount: {min:1, max:16} },//钻石块
            { type: 'vanilla', id: 'EMERALD', amount: {min:1, max:64} },//绿宝石
            { type: 'vanilla', id: 'EMERALD_BLOCK', amount: {min:1, max:16} },//绿宝石块
            { type: 'vanilla', id: 'COAL', amount: {min:1, max:64} },//煤炭
            { type: 'vanilla', id: 'COAL_BLOCK', amount: {min:1, max:64} },//煤炭块
            { type: 'vanilla', id: 'CHARCOAL', amount: {min:1, max:64} },//木炭
            { type: 'vanilla', id: 'COPPER_INGOT', amount: {min:1, max:64} },//铜锭
            { type: 'vanilla', id: 'RAW_COPPER', amount: {min:1, max:64} },//粗铜
            { type: 'vanilla', id: 'RAW_GOLD', amount: {min:1, max:64} },//粗金
            { type: 'vanilla', id: 'RAW_IRON', amount: {min:1, max:64} },//粗铁
            { type: 'vanilla', id: 'RAW_COPPER_BLOCK', amount: {min:1, max:64} },//粗铜块
            { type: 'vanilla', id: 'RAW_GOLD_BLOCK', amount: {min:1, max:64} },//粗金块
            { type: 'vanilla', id: 'RAW_IRON_BLOCK', amount: {min:1, max:64} },//粗铁块
            { type: 'vanilla', id: 'COPPER_BLOCK', amount: {min:1, max:64} },//铜块
            { type: 'vanilla', id: 'CUT_COPPER', amount: {min:1, max:64} },//切制铜块
            { type: 'vanilla', id: 'EXPOSED_COPPER', amount: {min:1, max:64} },//斑驳的铜块
            { type: 'vanilla', id: 'WEATHERED_COPPER', amount: {min:1, max:64} },//锈蚀的铜块
            { type: 'vanilla', id: 'OXIDIZED_COPPER', amount: {min:1, max:64} },//氧化的铜块
            { type: 'vanilla', id: 'CUT_COPPER_STAIRS', amount: {min:1, max:64} },//切制铜楼梯
            { type: 'vanilla', id: 'CUT_COPPER_SLAB', amount: {min:1, max:64} },//切制铜台阶
            { type: 'vanilla', id: 'WAXED_COPPER_BLOCK', amount: {min:1, max:64} },//涂蜡铜块
            { type: 'vanilla', id: 'WAXED_CUT_COPPER', amount: {min:1, max:64} },//涂蜡切制铜块
            { type: 'vanilla', id: 'WAXED_EXPOSED_COPPER', amount: {min:1, max:64} },//涂蜡斑驳铜块
            { type: 'vanilla', id: 'WAXED_WEATHERED_COPPER', amount: {min:1, max:64} },//涂蜡锈蚀铜块
            { type: 'vanilla', id: 'WAXED_OXIDIZED_COPPER', amount: {min:1, max:64} },//涂蜡氧化铜块

            { type: 'vanilla', id: 'COAL_ORE', amount: {min:1, max:64} },//煤矿石
            { type: 'vanilla', id: 'DEEPSLATE_COAL_ORE', amount: {min:1, max:64} },//深层煤矿石
            { type: 'vanilla', id: 'IRON_ORE', amount: {min:1, max:64} },//铁矿石
            { type: 'vanilla', id: 'DEEPSLATE_IRON_ORE', amount: {min:1, max:64} },//深层铁矿石
            { type: 'vanilla', id: 'GOLD_ORE', amount: {min:1, max:64} },//金矿石
            { type: 'vanilla', id: 'DEEPSLATE_GOLD_ORE', amount: {min:1, max:64} },//深层金矿石
            { type: 'vanilla', id: 'DIAMOND_ORE', amount: {min:1, max:64} },//钻石矿石
            { type: 'vanilla', id: 'DEEPSLATE_DIAMOND_ORE', amount: {min:1, max:64} },//深层钻石矿石
            { type: 'vanilla', id: 'EMERALD_ORE', amount: {min:1, max:64} },//绿宝石矿石
            { type: 'vanilla', id: 'DEEPSLATE_EMERALD_ORE', amount: {min:1, max:64} },//深层绿宝石矿石
            { type: 'vanilla', id: 'COPPER_ORE', amount: {min:1, max:64} },//铜矿石
            { type: 'vanilla', id: 'DEEPSLATE_COPPER_ORE', amount: {min:1, max:64} },//深层铜矿石
            { type: 'vanilla', id: 'LAPIS_ORE', amount: {min:1, max:64} },//青金石矿石
            { type: 'vanilla', id: 'DEEPSLATE_LAPIS_ORE', amount: {min:1, max:64} },//深层青金石矿石
            { type: 'vanilla', id: 'REDSTONE_ORE', amount: {min:1, max:64} },//红石矿石
            { type: 'vanilla', id: 'DEEPSLATE_REDSTONE_ORE', amount: {min:1, max:64} },//深层红石矿石
            { type: 'vanilla', id: 'NETHER_GOLD_ORE', amount: {min:1, max:64} },//下界金矿石
            { type: 'vanilla', id: 'ANCIENT_DEBRIS', amount: {min:1, max:8} },//远古残骸
            { type: 'vanilla', id: 'NETHER_QUARTZ_ORE', amount: {min:1, max:64} }//下界石英矿石
        ]
    },
    /* 幸运套装 */
    {
