...
const SlimyGroup = [
    /* 基础材料 50% */
    {
        ...
        allDrop: false,
        items: [
            { type: 'sf', id: 'LOGITECH_BUG', amount: { min: 1, max: 64 } },//BUG
            { type: 'sf', id: 'LOGITECH_LOGIGATE', amount: { min: 1, max: 64 } },//逻辑门
            { type: 'sf', id: 'LOGITECH_LOGIC', amount: { min: 1, max: 64 } },//逻辑
            { type: 'sf', id: 'LOGITECH_NOLOGIC', amount: { min: 1, max: 64 } },//反逻辑
            { type: 'sf', id: 'LOGITECH_EXISTE', amount: { min: 1, max: 64 } },//存在性
            { type: 'sf', id: 'LOGITECH_UNIQUE', amount: { min: 1, max: 64 } },//唯一性
            { type: 'sf', id: 'LOGITECH_PARADOX', amount: { min: 1, max: 16 } },//悖论
            { type: 'sf', id: 'LOGITECH_LENGINE', amount: { min: 1, max: 8 } },//逻辑引擎
            { type: 'sf', id: 'LOGITECH_LFIELD', amount: { min: 1, max: 32 } },//逻辑引擎力场
            { type: 'sf', id: 'LOGITECH_LSCHEDULER', amount: { min: 1, max: 4 } },//逻辑调度器
            { type: 'sf', id: 'LOGITECH_LCRAFT', amount: { min: 1, max: 4 } },//逻辑合成单元
            { type: 'sf', id: 'LOGITECH_LBOOLIZER', amount: { min: 1, max: 64 } },//布尔化核心
            { type: 'sf', id: 'LOGITECH_LMOTOR', amount: { min: 1, max: 8 } },//逻辑动力马达
            { type: 'sf', id: 'LOGITECH_LDIGITIZER', amount: { min: 1, max: 2 } },//数字化核心
            { type: 'sf', id: 'LOGITECH_LIOPORT', amount: { min: 1, max: 2 } },//IO组件
            { type: 'sf', id: 'LOGITECH_LPLATE', amount: { min: 1, max: 16 } },//薯片合金板
            { type: 'sf', id: 'LOGITECH_CHIP_INGOT', amount: { min: 1, max: 64 } },//薯片合金
            { type: 'sf', id: 'LOGITECH_ABSTRACT_INGOT', amount: { min: 1, max: 64 } },//抽象锭
            { type: 'sf', id: 'LOGITECH_WORLD_FEAT', amount: { min: 1, max: 8 } },//主世界特征
            { type: 'sf', id: 'LOGITECH_NETHER_FEAT', amount: { min: 1, max: 8 } },//下界特征
            { type: 'sf', id: 'LOGITECH_END_FEAT', amount: { min: 1, max: 8 } },//末地特征
            { type: 'sf', id: 'LOGITECH_FAKE_UI', amount: { min: 1, max: 64 } },//槽位伪装板
            { type: 'sf', id: 'LOGITECH_MANUAL_CORE', amount: { min: 1, max: 64 } },//乱序核心
            { type: 'sf', id: 'LOGITECH_REDSTONE_ENGINE', amount: { min: 1, max: 64 } },//赤石原力引擎
            { type: 'sf', id: 'LOGITECH_WITHERPROOF_REDSTONE', amount: { min: 1, max: 64 } },//防凋零红石块
            { type: 'sf', id: 'LOGITECH_WITHERPROOF_REDS', amount: { min: 1, max: 64 } },//防凋零红石
            { type: 'sf', id: 'LOGITECH_TNT_GEN', amount: { min: 1, max: 4 } },//便携式TNT复制机
            { type: 'sf', id: 'LOGITECH_BEDROCK_BREAKER', amount: { min: 1, max: 4 } },//便携式破基岩
            { type: 'sf', id: 'LOGITECH_SUPERSPONGE', amount: { min: 1, max: 4 } }//海曼牌海绵
        ]
    },
    /* 幸运套装 */
    {
    ...
    /* 特殊机器 */
    {
        ...
        allDrop: false,
        items: [
            { type: 'sf', id: 'LOGITECH_STORAGE', amount: { min: 1, max: 64 } },//普通存储单元
            { type: 'sf', id: 'LOGITECH_STORAGE_INPUT', amount: { min: 1, max: 48 } },//输入存储单元
            { type: 'sf', id: 'LOGITECH_STORAGE_OUTPUT', amount: { min: 1, max: 48 } },//输出存储单元
            { type: 'sf', id: 'LOGITECH_CARGO_PIP', amount: { min: 1, max: 64 } },//货运管道
            { type: 'sf', id: 'LOGITECH_SIMPLE_CARGO', amount: { min: 1, max: 8 } },//铃接传输器
            { type: 'sf', id: 'LOGITECH_LINE_CARGO', amount: { min: 1, max: 8 } },//链式传输器
            { type: 'sf', id: 'LOGITECH_ENERGY_PIPE', amount: { min: 1, max: 32 } }//铜质电线
        ]
    },
    /* 快捷机器 */
    {
        ...
        allDrop: false,
        items: [
            { type: 'sf', id: 'LOGITECH_CRAFT_MANUAL', amount: 1 },//快捷工作台
            { type: 'sf', id: 'LOGITECH_FURNACE_MANUAL', amount: 1 },//快捷熔炉
            { type: 'sf', id: 'LOGITECH_ENHANCED_CRAFT_MANUAL', amount: 1 },//快捷强化工作台
            { type: 'sf', id: 'LOGITECH_GRIND_MANUAL', amount: 1 },//快捷磨石
            { type: 'sf', id: 'LOGITECH_ARMOR_FORGE_MANUAL', amount: 1 },//快捷盔甲锻造台
            { type: 'sf', id: 'LOGITECH_ORE_CRUSHER_MANUAL', amount: 1 },//快捷矿石粉碎机
            { type: 'sf', id: 'LOGITECH_COMPRESSOR_MANUAL', amount: 1 },//快捷压缩机
            { type: 'sf', id: 'LOGITECH_PRESSURE_MANUAL', amount: 1 },//快捷压力机
            { type: 'sf', id: 'LOGITECH_MAGIC_WORKBENCH_MANUAL', amount: 1 },//快捷魔法工作台
            { type: 'sf', id: 'LOGITECH_ORE_WASHER_MANUAL', amount: 1 },//快捷洗矿机
            { type: 'sf', id: 'LOGITECH_GOLD_PAN_MANUAL', amount: 1 },//快捷淘金机
            { type: 'sf', id: 'LOGITECH_ANCIENT_ALTAR_MANUAL', amount: 1 },//快捷远古祭坛
            { type: 'sf', id: 'LOGITECH_SMELTERY_MANUAL', amount: 1 },//快捷冶炼炉
            { type: 'sf', id: 'LOGITECH_CRUCIBLE_MANUAL', amount: 1 },//快捷坩埚
            { type: 'sf', id: 'LOGITECH_PULVERIZER_MANUAL', amount: 1 },//快捷打粉机
            { type: 'sf', id: 'LOGITECH_TABLESAW_MANUAL', amount: 1 },//快捷台锯
            { type: 'sf', id: 'LOGITECH_COMPOSTER', amount: 1 },//快捷搅拌机
            { type: 'sf', id: 'LOGITECH_MULTIMACHINE_MANUAL', amount: 1 },//快捷综合机器
            { type: 'sf', id: 'LOGITECH_CARD_MAKER', amount: 1 },//快捷卡片制造机
            { type: 'sf', id: 'LOGITECH_MAGIC_STONE', amount: 1 },//魔法刷石机
            { type: 'sf', id: 'LOGITECH_INPORT', amount: 1 },//输入奇点交互
            { type: 'sf', id: 'LOGITECH_OUTPORT', amount: 1 },//输出奇点交互
            { type: 'sf', id: 'LOGITECH_IOPORT', amount: 1 },//均衡奇点交互
            { type: 'sf', id: 'LOGITECH_BOOL_GENERATOR', amount: 1 },//布尔生成器
            { type: 'sf', id: 'LOGITECH_LOGIC_REACTOR', amount: 1 },//逻辑反应堆   
            { type: 'sf', id: 'LOGITECH_BUG_CRAFTER', amount: 1 },//BUG工作台
            { type: 'sf', id: 'LOGITECH_RESETTER', amount: 1 }//数据重置仪
        ]
    },
    /* 事件触发组 5% */
    {
