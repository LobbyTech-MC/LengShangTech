const DISPLAY_NAME = '§a消§b耗§9卡 §d- §6急迫 IV';
...
function skillBuff(player) {
    ...
    //提供急迫效果
    const hasteEffect = PotionEffectType.getByName("HASTE") || PotionEffectType.FAST_DIGGING;

    const buffs = [
        new PotionEffect(hasteEffect, BUFF_TICKS, 3)
    ];
