const DISPLAY_NAME = '§a消§b耗§9卡 §d- §a抗火 I';
...
function skillBuff(player) {
    ...
    //提供抗火效果
    const fireResistanceEffect = PotionEffectType.getByName("FIRE_RESISTANCE") || PotionEffectType.FIRE_RESISTANCE;

    const buffs = [
        new PotionEffect(fireResistanceEffect, BUFF_TICKS, 0)
    ];
