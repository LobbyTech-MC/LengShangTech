const DISPLAY_NAME = '§a消§b耗§9卡 §d- §a潮涌能量 I';
...
function skillBuff(player) {
    ...
    //提供潮涌能量效果
    const conduitPowerEffect = PotionEffectType.getByName("CONDUIT_POWER") || PotionEffectType.CONDUIT_POWER;

    const buffs = [
        new PotionEffect(conduitPowerEffect, BUFF_TICKS, 0)
    ];
