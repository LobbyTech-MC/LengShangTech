const DISPLAY_NAME = '§a消§b耗§9卡 §d- §a隐身 I';
...
function skillBuff(player) {
    ...
    //提供隐身效果
    const invisibilityEffect = PotionEffectType.getByName("INVISIBILITY") || PotionEffectType.INVISIBILITY;

    const buffs = [
        new PotionEffect(invisibilityEffect, BUFF_TICKS, 0)
    ];
